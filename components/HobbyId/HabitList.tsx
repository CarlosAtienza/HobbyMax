  ...
  return (
    <View style={habitStyles.container}>
      <View style={habitStyles.headerRow}>
        ...
        {onAddHabit && (
          <TouchableOpacity style={habitStyles.addIconButton} onPress={onAddHabit}>
      ...
      {(!habits || habits.length === 0) ? (
        <View style={habitStyles.emptyState}>
          ...
          <Text style={habitStyles.emptySubtext}>Build consistency with daily habits</Text>
          {onAddHabit && (
            <TouchableOpacity style={habitStyles.emptyAddButton} onPress={onAddHabit}>
        ...
        <>
          ...
          <View style={habitStyles.footer}>
            <Text style={habitStyles.countText}>
              {habits.length} {habits.length === 1 ? 'habit' : 'habits'} to build
            </Text>
          </View>
        </>
      )}
